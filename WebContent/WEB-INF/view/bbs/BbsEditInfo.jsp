...
<body onload="doOnload();">
	...
	<div class="container" style="margin-top: 30px;">
		<h2>자유게시판 글수정</h2>
		<form name="f" method="post" action="/bbs/BbsUpdate.do"
			onsubmit="return doSubmit(this);">
			<input type="hidden" name="bSeq"
				value="<%=CmmUtil.nvl(request.getParameter("bSeq"))%>" /> <input
				type="text" class="form-control" name="title" id="btnSuc"
				value="<%=CmmUtil.nvl(bDTO.getTitle())%>" /><br>
			<textarea name="contents" class="form-control" rows="20"><%=CmmUtil.nvl(bDTO.getContents())%></textarea>
			<br>
